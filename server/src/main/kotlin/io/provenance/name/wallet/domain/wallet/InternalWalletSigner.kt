package io.provenance.name.wallet.domain.wallet
...
enum class InternalNetworkType(
    /**
...
class InternalWalletSigner(networkType: InternalNetworkType, mnemonic: String, passphrase: String = "") : Signer {
